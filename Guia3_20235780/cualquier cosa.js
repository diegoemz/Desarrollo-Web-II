        ...
        */
        async function fetchMovies() {
            try {
                ...
                // Petición a la API de OMDb con la clave de acceso y la consultaconst 
                response = await
                ...
                // Manejo de errores: guardar el mensaje de error y limpiar la lista de películas
        ...
        */
        async function fetchMovies() {
            try {
                ...
                // Petición a la API de OMDb con la clave de acceso y la consultaconst 
                response = await
                    fetch(`http://www.omdbapi.com/?i=tt3896198&apikey=a2e55271&s=${query}`);
                // Verifica si la respuesta HTTP es correcta
                if (!response.ok)
                    throw new Error("Error al cargar películas");
